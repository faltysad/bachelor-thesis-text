...
%% TODO:
% Pod úvod přidat rozcestníkovou kapitolu "Formalizace" - VAE se skladá z autoenkodéru definovaného ... a dekodéru definovaného ..., pro trénování používá ELBo a reparametrizační trik atd -> jedna stránka co to bude shrnovat a "odkazovat" dál do techničtějších sekcí
...
\input{sections/03_variacni_autoenkoder/06_objective}
\input{sections/03_variacni_autoenkoder/07_optimalizace}
\input{sections/03_variacni_autoenkoder/08_testovani}
\input{sections/03_variacni_autoenkoder/09_interpretace_objective}
