...
\input{sections/03_variacni_autoenkoder/07_generovani_vzorku}
\input{sections/03_variacni_autoenkoder/08_testovani}
\input{sections/03_variacni_autoenkoder/09_omezeni}
\input{sections/03_variacni_autoenkoder/10_aktualni_stav_poznani}
\input{sections/03_variacni_autoenkoder/11_pozorovani_v_latentnim_prostoru}


\chapter{Úlohy pozorování v~latentním prostoru}
\label{chap:applications}
\input{sections/04_ulohy_pozorovani_v_latentnim_prostoru/00_ulohy_pozorovani_v_latentnim_prostoru_intro}
