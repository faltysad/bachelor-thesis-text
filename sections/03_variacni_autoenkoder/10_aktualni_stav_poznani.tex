\section{Aktuální stav poznání}
\label{sec:vae_extensions}
Tato sekce nabízí přehled technik, které se svým principem podobají variačním autoenkodérům a prezentuje jejich odlišnosti.
Jejím účelem je prezentovat existující rozšíření a alternativy variačního autoenkodéru. Evaluace prezentovaných technik je nad rámec tento práce, a proto je vždy v každé dílčí sekci odkázáno do originální publikace.
