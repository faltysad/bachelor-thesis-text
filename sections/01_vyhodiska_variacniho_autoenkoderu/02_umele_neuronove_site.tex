...
Dopředné umělé neuronové sítě nazýváme \emph{dopředné}, jelikož v této architektuře neexistují žádné zpětnovazební propojení, které by sloužily jako vstup zpět pro sebe sama
...
Dopředné umělé neuronové sítě nazýváme \emph{sítě}, jelikož jsou typicky reprezentovány kompozicí více různých funkcí.
...
Takto zřetězené struktury nazýváme \textbf{vrstvy} umělé neuronové sítě. Délku tohoto zřetězení nazýváme \textbf{hloubkou} modelu – od tud \emph{hluboké} učení. \cite{Goodfellow2016}
