...
Autoenkodér, jehož dimenze kódu (\emph{h}) je nižší, než dimenze vstupu nazýváme \textbf{neúplný}.
Učení neuplné reprezentace \emph{nutí} Autoenkodér zachytit pouze ty nejvíce charakteristické vlastnosti trénovacích dat.
...
Důležitým důsledkem tohoto jevu je, že \textbf{Autoenkodéry} s nelineární kódovací funkcí $f$ a nelineární dekódovací funkcní $g$ \textbf{jsou schopny učit se obecnější generalizaci} než u Analýzy hlavních komponent.
