...
\begin{figure}[H]
    ...
    \node[root] {\textbf{Autoenkodér}}
        child {node[level-2] (c1) {\textbf{Architektura ANN}}}
        child {node[level-2] (c2) {\textbf{Regularizační prvek}}}
    ...
    \begin{scope}[every node/.style={level-3}]
        ...
        \node [below of = c12] (c13) {Stacked autoenkodér};
        \node [below of = c13] (c14) {Hluboký autoenkodér};
