...
kde $\tilde{\textbf{\emph{x}}}$ je kopií $\textbf{\emph{x}}$ která byla úmyslně poškozena (např. přidáním šumu, smazáním části vstupních neuronů).
...
-> dva podobné vstupy musí mít podobné i kódy!
