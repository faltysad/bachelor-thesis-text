...
Hluboký autoenkodér (\emph{Deep} autoenkodér), je takový Autoenkodér, který má víc než jednu skrytou vrstvu.
Hluboký autoenkodér lze trénovat vrstvu po vrstvě formou více \emph{shallow stacked} autoenkodérů zasebou. Nebo jako hlubokou neuronovou síť.
        ...
        [
            Autoenkodér
                [Architektura umělé neuronové sítě
                    [Autoenkodér s neúplnou skrytou vrstvou]
                    [Autoenkodér s rozšířenou skrytou vrstvou]
                    [Hluboký autoenkodér]
                ]
                [Regularizační prvek
                    [Řídký autoenkodér]
                    [Denoising autoenkodér]
                    [Contractive autoenkodér]
                ]
        ]
    \end{forest}

    \caption{Autoenkodéry rozděleny podle charakteristik zpracování kódovací vrstvy}
\end{figure}
