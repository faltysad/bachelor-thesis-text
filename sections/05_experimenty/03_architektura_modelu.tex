...
\lstinputlisting[language=Python, caption=Obecný trénovací krok modelu variačního autoenkodéru pro generativní úlohu]{code_snippets/vae_loss_function.py}
...
\lstinputlisting[language=Python, caption=Sestavení modelu variačního autoenkodéru pro generativní model MNIST číslic.]{code_snippets/vae_model.py}
