...
\footnote{V literatuře se můžeme zřídka setkat s zařazením autoenkodérů \textbf{obecně} do třídy \emph{semi-supervised} algoritmů strojového učení, například \cite[str. 95]{Chollet2017}. Domnívám se, že přesnější formulací je zařazení \textbf{obecné} architektury autoenkodérů do třídy algoritmů učení bez učitele. Nutno předeslat (viz \autoref{sec:stacked_autoencoder}), že v architekturách hlubokých autoenkodérů je běžným jevem tzv. \emph{stacked autoenkodér}, kde je nejprve trénováno vícero \emph{mělkých} autoenkodérů stylem učení bez učitele. Takto natrénované autoenkodérý jsou poté seřazeny za sebe jako vrstvy nové umělé neuronové sítě, která v další fázi prochází trénování stylem učení s učitelem, a to za účelem ladění celé sítě k specifickému účelu \cite{Bengio2006}, \cite{Ranzato2007}, \cite{Erhan2010}. V instancích tohoto případu \textbf{lze} hovořit o zařazení autoenkodéru do třídy semi-supervizovaného učení.}.
